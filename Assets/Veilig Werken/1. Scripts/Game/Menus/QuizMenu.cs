...
namespace VeiligWerken.Menus
{
	...
	public class QuizMenu : Menu
	{
		...
		private void UpdateQuestions()
		{
			...
			answersGridLayoutGroup.cellSize = new Vector2(answersSize.width, answersSize.height / QuizQuestion.MAX_ANSWERS * 90 / 100);
			answersGridLayoutGroup.spacing = Vector2.up * answersSize.height / QuizQuestion.MAX_ANSWERS * 10 / 100;
		...
		private void OnAnswerClicked(bool correctAnswerClicked)
		{
			...
			//Update score text.
			/*You have answered all questions. Your score is 7/10.*/
			var scoreText = Content.FindInAllChildren("ScoreText").GetComponent<TextMeshProUGUI>();
			scoreText.SetText($"You have answered all questions.");
		}
